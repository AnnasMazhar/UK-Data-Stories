...
if data.get('months') and data.get('counts'):
    ...
    fig.update_layout(title="Transport Dataset Publishing Over Time", xaxis_title="Month", yaxis_title="Count", template="plotly_white", height=350)
    st.plotly_chart(fig, use_container_width=True)

st.markdown("### Sample Datasets")
for d in get_datasets("transport")[:10]:
