...
st.title("📊 Economy Data")
data = get_topic_data("economy")
...
if data.get('months') and data.get('counts'):
    ...
    fig.update_layout(title="Economy Publishing Over Time", template="plotly_white", height=350)
