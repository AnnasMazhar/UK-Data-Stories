...
if data.get('months') and data.get('counts'):
    ...
    fig.update_layout(title="Parliament Dataset Publishing Over Time", xaxis_title="Month", yaxis_title="Count", template="plotly_white", height=350)
